...
global $APPLICATION;
$APPLICATION->SetTitle("Презентации о продукте");
    ...
    <div class="static-content static-flex-wrap">
        <div class="b-tabs">
            ...
            <? $APPLICATION->IncludeComponent(
                ...
                [
                    "COMPONENT_TEMPLATE" => "promotional_materials",
                    "IBLOCK_TYPE" => "marketing_support",
                    "IBLOCK_ID" => $core->getIblockId($core::IBLOCK_CODE_MARKETING_SUPPORT_SOUVENIRS),
                    "NEWS_COUNT" => "10",
