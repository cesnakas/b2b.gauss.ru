...
$arUrlRewrite = array();
if(file_exists($_SERVER['DOCUMENT_ROOT']."/custom_urlrewrite.php"))
	include($_SERVER['DOCUMENT_ROOT']."/custom_urlrewrite.php");
...
if((isset($_SERVER['REDIRECT_STATUS']) && $_SERVER['REDIRECT_STATUS'] == '404') || isset($_GET["SEF_APPLICATION_CUR_PAGE_URL"]))
{
	...
	if (isset($_GET["SEF_APPLICATION_CUR_PAGE_URL"])
		&& (
            ...
            || ($requestUriWithoutParams != "/bitrix/custom_urlrewrite.php")
		)
	)
	{
	...
	define("POST_FORM_ACTION_URI", htmlspecialcharsbx("/bitrix/custom_urlrewrite.php?SEF_APPLICATION_CUR_PAGE_URL=".urlencode($uriPath)));
}
