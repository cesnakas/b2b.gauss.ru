...
use Citfact\Tools\Module\Module;
...
class Dispatcher implements DispatcherInterface
{
    ...
    public function registerByModule($moduleName)
    {
        ...
        foreach ($finder as $file) {
            ...
            if ($reflection->isSubclassOf('Citfact\\Tools\\Event\\ListenerInterface') && !$reflection->isAbstract()) {
        ...
        foreach ($finder as $file) {
            $class = $prefix.'\\'.$file->getBasename('.php');
            $reflection = new \ReflectionClass($class);
            if ($reflection->isSubclassOf('Citfact\\Tools\\Event\\SubscriberInterface') && !$reflection->isAbstract()) {
