...
class citfact_datacache extends CModule
{
    /**
     * @var string
     */
    public $MODULE_ID = 'citfact.datacache';
    ...
    {
        $this->MODULE_NAME = Loc::getMessage('CITFACT_DATACACHE_IMPORT_MODULE_NAME');
        $this->MODULE_DESCRIPTION = Loc::getMessage('CITFACT_DATACACHE_IMPORT_MODULE_DESCRIPTION');
        $this->PARTNER_NAME = Loc::getMessage('CITFACT_DATACACHE_PARTNER_NAME');
        $this->PARTNER_URI = Loc::getMessage('CITFACT_DATACACHE_PARTNER_URI');
