...
class BaseMigration
{
    ...
    public function setWebForm($formData, $formFieldData = [], $webFormId = false)
    {
        ...
        $res = $form->GetList($by = 'ID', $order = 'ASC', ['SID' => $formData['SID']], $isFiltered);
        $webForm = $res->Fetch();
        if ($webForm) {
    ...
    public function setWebFormFields($formFieldData, $webFormId)
    {
        ...
        $res = $formField->GetList($webFormId, 'ALL', $by = 'ID', $order = 'ASC', ['SID' => array_keys($formFieldData)], $isFiltered);
        while ($item = $res->Fetch()) {
        ...
        foreach ($formFieldData as &$item) {
            ...
            $res = $formAnswer->GetList($item['ID'], $by = 'ID', $order = 'ASC', [], $isFiltered);
    ...
    public function setWebFormStatus($webFormId)
    {
        ...
        $res = $formStatus->GetList($webFormId, $by = 'ID', $order = 'ASC', [], $isFiltered);
        $webFormStatus = null;
