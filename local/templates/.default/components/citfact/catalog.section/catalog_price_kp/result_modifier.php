...
if (!empty($arResult['ITEMS'])){
	...
	{
		///$arItem["QUANTITY_INFO"] = $cItemAvailability->getQuantityInfo($arItem);
		...
		$arItem = $elementRepository->getAdditionalInfo($arItem);
...
global $catalogSectionItemIds;
$catalogSectionItemIds = $itemIds;