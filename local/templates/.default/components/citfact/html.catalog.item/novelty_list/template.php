...
$item['PROPERTY_KOLICHESTVO_V_UPAKOVKE_VALUE'] = $item['PROPERTIES']['KOLICHESTVO_V_UPAKOVKE']['VALUE'];
$item['PROPERTY_CML2_ARTICLE_VALUE'] = $item['PROPERTIES']['CML2_ARTICLE']['VALUE'];
?>
<!-- item-container -->
<div class="swiper-slide" id="<?= $arParams['AREA_ID'] ?>">
    <div class="p" data-item-container="<?= $item['ID'] ?>" id="<?php echo $arParams['AREA_ID']; ?>" itemscope itemtype="http://schema.org/Product">
        ...
        <?if($item['PROPERTY_NOVINKA_VALUE']==='Да'):?>
        ...
        <div class="p__middle">
            ...
            <div class="p__params">
                ...
                <div class="p__param">
                    ...
                    <div><?= $item['PROPERTY_CML2_ARTICLE_VALUE'];?></div>
                </div>
                <?php
            ...
            <?if ($item['PRICE'] != ''){?>
                ...
                <div class="p__btns">
                    ...
                    <div class="p__btns-w">
                        ...
                        <span class="tooltip__handle-text" data-kolvo-vupakovke="<?=$item['PROPERTY_KOLICHESTVO_V_UPAKOVKE_VALUE']; ?>"  data-itemId="<?= $item['ID'] ?>" style="display: none;">
                        ...
                        <div class="basket-item__text" id="basket-item-upakovka-wrap-<?= $item['ID'] ?>" <?if($item['PROPERTY_KOLICHESTVO_V_UPAKOVKE_VALUE'] == 1) : ?>style="display: none" <? endif; ?>>
                            <div>Кол-во не кратно упаковке.</div>
                            <span class="btn-add-box btn--small btn--grey" data-id="<?= $item['ID'] ?>" id="button-quantity-<?= $item['ID'] ?>">
                                Добавьте
                                <span data-max-quantity="<?= $item['PROPERTY_KOLICHESTVO_V_UPAKOVKE_VALUE'] ?>" id="basket-item-upakovka-cnt-<?= $item['ID'] ?>">
                                    <? echo $item['PROPERTY_KOLICHESTVO_V_UPAKOVKE_VALUE'] - 1 ?>
                                </span>
                        шт. до коробки
                    </span>
                        </div>
