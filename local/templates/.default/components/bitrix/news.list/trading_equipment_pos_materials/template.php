    ...
    <div class="b-tabs__item active">
        <div class="blocks">
            <div class="blocks__top">
                <a href="/local/include/modals/m-equip-request.php" class="btn btn--transparent" data-modal="marketing">
                    Отправить заявку
                </a>
                <p>Вы можете добавить в заявку любое количество позиций</p>
            </div>
            <div class="blocks__inner blocks__inner--pos" id="block_<?= $bxajaxid ?>">
