...
class CatalogSectionComponent extends ElementList
{
	...
	public function onPrepareComponentParams($params)
	{
        ...
        $params["ELEMENT_SORT_FIELD2"] = 'PROPERTY_E_Commerce_val';
        $params["ELEMENT_SORT_ORDER2"] = $params["ELEMENT_SORT_ORDER"];
	...
	protected function initSectionResult()
	{
        ...
        $selectFields[] = 'UF_NAME_VP';
        $selectFields[] = 'UF_NAME_RP';
	...
	protected function getElementList($iblockId, $products)
	{
		...
		$elementIterator = \Citfact\SiteCore\GaussGetList\CIBlockElement::GetList(
			$this->sortFields,
		...
		{
			parent::initNavString($elementIterator);
		}
