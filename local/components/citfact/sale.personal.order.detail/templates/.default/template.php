...
else
{
	...
	<div class="container-fluid sale-order-detail">
		...
		{
			?>
			<a class="sale-order-detail-back-to-list-link-up" title="<?= Loc::getMessage('SPOD_RETURN_LIST_ORDERS') ?>" href="<?= htmlspecialcharsbx($arResult["URL_TO_LIST"]) ?>">
							...
							<div class="row">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" title="<?= Loc::getMessage('SPOD_ORDER_REPEAT') ?>" class="sale-order-detail-about-order-inner-container-repeat-button">
										...
										{
											?>
											<a href="<?=$arResult["URL_TO_CANCEL"]?>" title="<?= Loc::getMessage('SPOD_ORDER_CANCEL') ?>" class="sale-order-detail-about-order-inner-container-repeat-cancel">
									...
									if (strlen($arResult["USER"]["EMAIL"]) && !in_array("EMAIL", $arParams['HIDE_USER_INFO']))
									{
										...
										<li class="sale-order-detail-about-order-inner-container-list-item">
											...
											<a class="sale-order-detail-about-order-inner-container-list-item-link"
                                               title="<?= htmlspecialcharsbx($arResult["USER"]["EMAIL"]) ?>"
											...
											<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													<div class="col-md-8 col-sm-7 col-xs-10 sale-order-detail-payment-options-methods-info">
														...
														{
															?>
															<a href="javascript:void(0);" title="<?=Loc::getMessage('SPOD_CHANGE_PAYMENT_TYPE')?>" id="<?=$payment['ACCOUNT_NUMBER']?>" class="sale-order-detail-payment-options-methods-info-change-link"><?=Loc::getMessage('SPOD_CHANGE_PAYMENT_TYPE')?></a>
															<?
														}
														?>
														<?
